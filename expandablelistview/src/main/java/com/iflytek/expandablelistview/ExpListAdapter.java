...
public class ExpListAdapter extends BaseExpandableListAdapter {
    ...
    private final ArrayList<Group> gData;
    private final ArrayList<ArrayList<Item>> iData;
    private final Context mContext;

    public ExpListAdapter(ArrayList<Group> gData, ArrayList<ArrayList<Item>> iData, Context mContext) {
        this.gData = gData;
        this.iData = iData;
